...
function UseEffectComponentDefendency() {
    ...
    useEffect(() => {
        ...
        fetchPosts();
    }, [currentPage, postsPerPage]); //Dependency array includes currentPage and postsPerPage
...
export default UseEffectComponentDefendency;